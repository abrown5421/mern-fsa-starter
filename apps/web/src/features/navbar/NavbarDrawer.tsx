...
const DrawerNavbar: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full">
            <Link onClick={closeOnClick} className={classString("/")} to="/">Home</Link>
            <Link onClick={closeOnClick} className={classString()} target='blank' to="https://google.com">Test</Link>
            {!isAuthenticated && (
            ...
            {isAuthenticated && user && (
                <div className="flex flex-col h-full">
                    ...
                    <Link onClick={closeOnClick} className={classString("/profile")} to="/profile">Profile</Link>
